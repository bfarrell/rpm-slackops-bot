...
rpm-slackops-bot is a chat bot built on the [Hubot][hubot] framework. It was
...
You can start rpm-slackops-bot locally by running:
...
Then you can interact with rpm-slackops-bot by typing `rpm-slackops-bot help`.

    rpm-slackops-bot> rpm-slackops-bot help
    rpm-slackops-bot animate me <query> - The same thing as `image me`, except adds [snip]
    rpm-slackops-bot help - Displays all of the help commands that rpm-slackops-bot knows about.
    ...
